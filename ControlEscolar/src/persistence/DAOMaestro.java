 ...
 * @author HikingC7
 */
public class DAOMaestro extends DAOGeneral<ArrayList<Maestro>, ArrayList<Maestro>>
{
    ...
    @Override
    public void saveData(ArrayList<Maestro> maestros)
    {
    ...
    @Override
    public ArrayList<Maestro> loadData()
    {
        try
        {
